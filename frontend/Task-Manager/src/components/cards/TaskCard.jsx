...
const TaskCard = ({
    ...
    return (
        <div
            className='bg-white rounded-xl py-4 shadow-sm shadow-gray-100 border border-gray-200/50 cursor-pointer'
            onClick={onClick}>
                ...
                <div className="flex items-center justify-between mt-3">
                    ...
                    {attacmentCount > 0 && (
                        <div className="flex items-center gap-2 bg-blue-50 px-2.5 py-1.5 rounded-lg">
                            ...
                            <span className='text-xs text-gray-900'>{attacmentCount}</span>
                        </div>
                    )}
                </div>
            </div>
